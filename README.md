# **Propuesta de Proyecto: Sistema Kiosco Interactivo (InfoDuoc UC San Joaquín)**

### Descripción
* **Qué hace:** Aplicación web para tótem táctil con mapa SVG interactivo de 8 pisos, directorio y buscador con tolerancia a errores.
